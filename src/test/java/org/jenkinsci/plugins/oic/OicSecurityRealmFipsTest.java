...
class OicSecurityRealmFipsTest {
    ...
    void settingNonCompliantValuesNotAllowedTest() throws IOException, Descriptor.FormException {
        OicSecurityRealm realm = new OicSecurityRealm("clientId", Secret.fromString("secret"), false,null,null, false, null, null);
        Descriptor.FormException ex = assertThrows(
                Descriptor.FormException.class,
                () -> new OicSecurityRealm("clientId", Secret.fromString("secret"), false,null,null, true, null, null));
        assertThat(
